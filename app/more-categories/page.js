import '../css/more-categories.css'
...
export default function moreCategories() {
  return (
    ...
    <div className="more-container">
      ...
      <a href="/ebony" className="link">Ebony</a>
      <a href="/amateur" className="link">Amateur</a>
      ...
      <a href="/toys" className="link">toys</a>
      <a href="/family" className="link">Family</a>
      <a href="/hardcore" className="link">hardcore</a>
      <a href="/handjob" className="link">Handjob</a>
